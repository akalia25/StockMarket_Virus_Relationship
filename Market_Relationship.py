...
def virus_data():
    ...
    virus_data = {'2020-01-21': 446, '2020-01-22': 579, '2020-01-23': 844,
                  ...
                  '2020-03-15': 169593, '2020-03-16': 182490, '2020-03-17': 198238,
                  '2020-03-18': 218822, '2020-03-19': 244933, '2020-03-20': 275597,
                  '2020-03-21': 305036, '2020-03-22': 337489, '2020-03-23': 378860}
...
def market_virus_plot():
    ...
    ax1.plot(market_df.index,
             market_df.iloc[:, 0], color=color, label='SPY-CLOSE')
    ax1.plot(market_df.index,
             market_df.iloc[:, 1], color='orange', label='MCHI-CLOSE')
